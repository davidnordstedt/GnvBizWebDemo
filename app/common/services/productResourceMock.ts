module app.common {
    ...
    function mockRun($httpBackend: ng.IHttpBackendService) : void {
        ...
        var gainesvilleServices: app.domain.IGainesvilleService[] = [];
        var gainesvilleService: app.domain.IGainesvilleService;

        //gainesvilleService = new app.domain.GainesvilleService();
        //gainesvilleServices.push(gainesvilleService);

        var gainesvilleServicesUrl = "/api/gainesvilleServices";

        $httpBackend.whenGET(gainesvilleServicesUrl).respond(gainesvilleServices);
